...
export const DB_SETUP_HINT =
  'Database unavailable. Start Postgres: `docker compose up -d` in frontend/, then `bun run db:push` and `bun run db:seed`. Ensure DATABASE_URL matches (default port 5434).'
