...
<body style="font-family: Georgia, serif; color: #1a1a1a; line-height: 1.6; max-width: 560px; margin: 0 auto; padding: 24px;">
  <div style="border-bottom: 3px solid #8B4513; padding-bottom: 16px; margin-bottom: 24px;">
    <h1 style="margin: 0; font-size: 22px; color: #5C3317;">Visit Harar</h1>
...
export async function sendNewBookingAlert(
  ...
  try {
    ...
    const html = emailLayout(
      ...
      <p><a href="${adminLink}" style="display:inline-block;padding:10px 16px;background:#5C3317;color:#fff;text-decoration:none;border-radius:4px;">View in dashboard</a></p>
      `,
      bureau,
    );
