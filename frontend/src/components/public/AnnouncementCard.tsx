    ...
    >
      ...
      <div className="p-5">
        <div className="flex items-center gap-2 text-xs">
          <span className="px-2 py-0.5 rounded-full bg-brand/10 text-brand font-semibold">{type}</span>
          <span className="text-ink-muted ml-auto">{formatDate(published_at)}</span>
        </div>
