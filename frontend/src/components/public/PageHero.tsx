...
export function PageHero({
  ...
  const bg = backgroundImage ? optimizeImage(backgroundImage, { width: 1600 }) : null
  ...
  return (
    <section className="relative pt-32 pb-16 text-white overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-t from-black via-black/40 to-black/20" style={{ opacity: overlayOpacity }} />
      <div
      ...
      <div className="relative max-w-7xl mx-auto px-5 lg:px-8">
        ...
        {subtitle ? <p className="mt-3 text-white/75 max-w-2xl">{subtitle}</p> : null}
      </div>
    </section>
  )
}
