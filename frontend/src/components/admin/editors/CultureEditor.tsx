...
export function CultureEditor({
  ...
  function commit(next?: Partial<{ hero: string; intro: string; sections: Section[]; festivals: Festival[] }>) {
    ...
    <div className="space-y-6">
      ...
      <AdminCard className="p-6">
        ...
        <div className="space-y-6">
          ...
          <div className="flex gap-2">
            <Button type="button" variant="outline" onClick={() => setSections([...sections, { title: '', body: '' }])}>
              Add section
            </Button>
      ...
      <AdminCard className="p-6">
        ...
        <div className="space-y-3">
          {festivals.map((f, i) => (
            <div key={i} className="grid md:grid-cols-[1fr_1fr_2fr_auto] gap-2 items-start">
              <Input
                value={f.name}
                onChange={(e) => {
                  const c = [...festivals]
              ...
              <button
                ...
                onClick={() => setFestivals(festivals.filter((_, j) => j !== i))}
              >
                ×
              </button>
            </div>
          ...
          <div className="flex gap-2 pt-2">
            <Button type="button" variant="outline" onClick={() => setFestivals([...festivals, { name: '', date: '', description: '' }])}>
              Add festival
            </Button>
