    ...
    <div className="min-h-screen grid place-items-center bg-brand-dark px-4">
      ...
      >
        <div className="flex flex-col items-center mb-6">
          <span className="w-14 h-14 rounded-full bg-brand text-white grid place-items-center font-serif text-2xl font-bold">
            H
          </span>
          <h1 className="font-serif text-2xl font-bold mt-3">Visit Harar</h1>
          <div className="text-ink-muted text-sm">CMS Login</div>
          <p className="text-[11px] text-ink-muted mt-2">Official Bureau Staff Access Only</p>
        </div>
